          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
				...
				<li><a class="nav-link" href="<?php echo site_url('bangsal'); ?>">Bangsal</a></li>
                  <li class="active"><a class="nav-link" href="<?php echo site_url('master_triase_macam_kasu'); ?>">Macam Kasus</a></li>
				...
				<section class="section">
					<div class="section-header">
						...
						<div class="section-header-breadcrumb">
							...
							<div class="breadcrumb-item"><a href="#">Macam Kasus</a></div>
					...
					<div class="section-body">
						<div class="card">
							<div class="card-header">
								<h4>Daftar Macam Kasus</h4>
							</div>
							<div class="card-body">
								<div class="pull-right mb-4">
								
	<a href="<?php echo site_url('master_triase_macam_kasu/add'); ?>" class="btn btn-success">Add</a> 
</div>
...
<table class="table table-striped table-bordered">
	...
	<?php foreach($master_triase_macam_kasus as $m){ ?>
    <tr>
		<td><?php echo $m['kode_kasus']; ?></td>
		<td><?php echo $m['macam_kasus']; ?></td>
		<td>
