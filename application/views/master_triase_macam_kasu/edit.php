			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1>Edit Macam Kasus</h1>
						<div class="section-header-breadcrumb">
							<div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
							<div class="breadcrumb-item"><a href="#">Edit Macam Kasus</a></div>
					...
					<div class="section-body">
						<div class="card">
							<div class="card-header">
								<h4>Edit Macam Kasus</h4>
							</div>
							<div class="card-body">
								<div class="pull-right mb-4">


								<?php echo form_open('master_triase_macam_kasu/edit/'.$master_triase_macam_kasu['kode_kasus'],array("class"=>"form-horizontal")); ?>
</div>
<div class="form-group">
	<label for="macam_kasus" class="col-md-4 control-label">Macam Kasus</label>
	<div class="col-md-8">
    <input type="text" name="macam_kasus" value="<?php echo ($this->input->post('macam_kasus') ? $this->input->post('macam_kasus') 
    : $master_triase_macam_kasu['macam_kasus']); ?>" class="form-control" id="macam_kasus" />
	</div>
</div>
