				...
				<section class="section">
					<div class="section-header">
						...
						<div class="section-header-breadcrumb">
							...
							<div class="breadcrumb-item"><a href="#">Tambah Bangsal</a></div>
					...
					<div class="section-body">
						<div class="card">
							<div class="card-header">
								<h4>Tambah Bangsal</h4>
							</div>
							<div class="card-body">
								<div class="pull-right mb-4">
								<?php echo form_open('bangsal/add',array("class"=>"form-horizontal")); ?>
	</div>
<div class="form-group">
	<label for="nm_bangsal" class="col-md-4 control-label">Nm Bangsal</label>
	<div class="col-md-8">
		<input type="text" name="nm_bangsal" value="<?php echo $this->input->post('nm_bangsal'); ?>" class="form-control" id="nm_bangsal" />
	</div>
</div>
<div class="form-group">
