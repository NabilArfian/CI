        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li class="active"><a class="nav-link" href="<?php echo site_url('bangsal'); ?>">Bangsal</a></li>
				...
				<section class="section">
					<div class="section-header">
						...
						<div class="section-header-breadcrumb">
							...
							<div class="breadcrumb-item"><a href="#">Bangsal</a></div>
					...
					<div class="section-body">
						<div class="card">
							<div class="card-header">
								<h4>Daftar Bangsal</h4>
							</div>
							<div class="card-body">
								<div class="pull-right mb-4">
	<a href="<?php echo site_url('bangsal/add'); ?>" class="btn btn-success">Add</a>
  <a href="<?php echo site_url("bangsal/export"); ?>" class="btn btn-primary">Export ke Excel</a> 
</div>

<table class="table table-striped table-bordered" id="table">
  <thead>
    <tr>
		<th width="20%">Kd Bangsal</th>
		<th width="40%">Nm Bangsal</th>
    ...
    <td>
      <a href="<?php echo site_url('master_triase_macam_kasu/edit/'.$m['kode_kasus']); ?>" class="btn btn-info btn-xs">Edit</a> 
      <a href="<?php echo site_url('master_triase_macam_kasu/remove/'.$m['kode_kasus']); ?>" class="btn btn-danger btn-xs">Delete</a>      
    </td>
    </tr>
	<?php } ?>
  </tbody>
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function() {
          ...
          table = $('#table').DataTable({ 
              ...
              "ajax": {
                  "url": "<?php echo site_url('bangsal/get_data_user')?>",
                  "type": "POST"
              },
