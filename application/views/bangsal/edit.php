				...
				<section class="section">
					<div class="section-header">
						...
						<div class="section-header-breadcrumb">
							...
							<div class="breadcrumb-item"><a href="#">Edit Bangsal</a></div>
...
<?php echo form_open('bangsal/edit/'.$bangsal['kd_bangsal'],array("class"=>"form-horizontal")); ?>
</div>
	<div class="form-group">
		<label for="nm_bangsal" class="col-md-4 control-label">Nm Bangsal</label>
		<div class="col-md-8">
      <input type="text" name="nm_bangsal" value="<?php echo ($this->input->post('nm_bangsal') ? $this->input->post('nm_bangsal') 
      : $bangsal['nm_bangsal']); ?>" class="form-control" id="nm_bangsal" />
		</div>
	</div>
	<div class="form-group">
      ...
      : $bangsal['status']); ?>" class="form-control" id="status" />
		</div>
	</div>
