          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
				...
				<li><a class="nav-link" href="<?php echo site_url('bangsal'); ?>">Bangsal</a></li>
                  ...
                  <li class="active"><a class="nav-link" href="<?php echo site_url('penyakit'); ?>">Penyakit</a></li>
                </ul>
              </li>
...
<table class="table table-striped table-bordered">
    ...
    <tr>
		...
		<td><?php echo $p['ciri_ciri']; ?></td>
		<td><?php echo $p['status']; ?></td>
		<td>
            <a href="<?php echo site_url('penyakit/edit/'.$p['kd_penyakit']); ?>" class="btn btn-info btn-xs">Edit</a> 
            <a href="<?php echo site_url('penyakit/remove/'.$p['kd_penyakit']); ?>" class="btn btn-danger btn-xs">Delete</a>
        </td>
    </tr>
	<?php } ?>
</table>
