...
<body>
  <div id="app">
			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1>Tambah Macam Penyakit</h1>
						<div class="section-header-breadcrumb">
							<div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
							<div class="breadcrumb-item"><a href="#">Tambah Macam Penyakit</a></div>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="nm_penyakit" value="<?php echo $this->input->post('nm_penyakit'); ?>" class="form-control" id="nm_penyakit" />
		</div>
	</div>
	<div class="form-group">
		<label for="ciri_ciri" class="col-md-4 control-label">Ciri Ciri</label>
		<div class="col-md-8">
			<input type="text" name="ciri_ciri" value="<?php echo $this->input->post('ciri_ciri'); ?>" class="form-control" id="ciri_ciri" />
		</div>
	</div>
	<div class="form-group">
