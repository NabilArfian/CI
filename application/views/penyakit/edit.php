        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
				<li><a class="nav-link" href="<?php echo site_url('bangsal'); ?>">Bangsal</a></li>
                  <li><a class="nav-link" href="<?php echo site_url('master_triase_macam_kasu'); ?>">Macam Kasus</a></li>
                  <li><a class="nav-link" href="<?php echo site_url('penyakit'); ?>">Penyakit</a></li>
                </ul>
              </li>
			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1>Edit Macam Penyakit</h1>
						<div class="section-header-breadcrumb">
							<div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
							<div class="breadcrumb-item"><a href="#">Edit Macam Penyakit</a></div>
					...
					<div class="section-body">
						<div class="card">
							<div class="card-header">
								<h4>Edit Macam Penyakit</h4>
							</div>
							<div class="card-body">
								<div class="pull-right mb-4">


								<?php echo form_open('penyakit/edit/'.$penyakit['kd_penyakit'],array("class"=>"form-horizontal")); ?>
</div>
	<div class="form-group">
		<label for="nm_penyakit" class="col-md-4 control-label">Nm Penyakit</label>
		<div class="col-md-8">
			<input type="text" name="nm_penyakit" value="<?php echo ($this->input->post('nm_penyakit') ? $this->input->post('nm_penyakit') 
			: $penyakit['nm_penyakit']); ?>" class="form-control" id="nm_penyakit" />
		</div>
	</div>
	<div class="form-group">
		<label for="ciri_ciri" class="col-md-4 control-label">Ciri Ciri</label>
		<div class="col-md-8">
			<input type="text" name="ciri_ciri" value="<?php echo ($this->input->post('ciri_ciri') ? $this->input->post('ciri_ciri') 
			: $penyakit['ciri_ciri']); ?>" class="form-control" id="ciri_ciri" />
		</div>
	</div>
	<div class="form-group">
		<label for="status" class="col-md-4 control-label">Status</label>
		<div class="col-md-8">
			<input type="text" name="status" value="<?php echo ($this->input->post('status') ? $this->input->post('status') 
			: $penyakit['status']); ?>" class="form-control" id="status" />
		</div>
	</div>
